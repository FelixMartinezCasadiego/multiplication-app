...
describe("save-file.use-case", () => {
  ...
  afterEach(() => {
    ...
    if (fileExists) fs.rmSync(filePath, { recursive: true });
  ...
  test("should return false if directory could be created", () => {
    const saveFile = new SaveFile();
  ...
  test("should return false if file could be created", () => {
    const saveFile = new SaveFile();
